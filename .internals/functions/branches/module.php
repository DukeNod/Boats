...
Class Branches extends Base_Module
{
	function __construct()
	{
		parent::__construct('branches', 'branch', 'Филиалы');

		$this->order_field = 'id';	// Поле сортировки записей.
		...
		$this->admin_sorters = array('id'=>false); // 'position'=>false, 'mr'=>false, 
