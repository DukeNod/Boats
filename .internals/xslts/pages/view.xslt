...
<xsl:template name="view_for_page">
	...
	<form enctype="multipart/form-data" method="post" action="{$action}">
		...
		<xsl:if test="$form/errors/*">
			...
			<tr class="formRowView">
				<th class="formCellHead"><nobr>mod_rewrite</nobr></th>
				<td class="formCellFlag"></td>
				<td class="formCellData">
					<xsl:value-of select="$form/data/mr" disable-output-escaping="no"/>
				</td>
			</tr>
			<tr class="formRow formRowView">
