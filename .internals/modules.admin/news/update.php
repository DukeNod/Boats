...
_main_::depend('linked_paras//commons'); $enum_unused = fetch_enums_for_linked_paras('news', $id);
_main_::depend('linked_picts//commons'); $enum_unused = fetch_enums_for_linked_picts('news', $id);
_main_::depend('linked_files//commons'); $enum_unused = fetch_enums_for_linked_files('news', $id);
...
_main_::put2dom('news_group', $info['group']);
