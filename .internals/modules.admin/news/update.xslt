...
<xsl:include href="../../xslts/news/errors.xslt"/>
<xsl:include href="../../xslts/news/form.xslt"/>
...
<xsl:template match="/" mode="overrideable_path">
	<xsl:call-template name="path_link"><xsl:with-param name="link" select="concat(/*/system/info/adm_root, 'news?group=', /*/news_group)"/><xsl:with-param name="text" select="$essence_title"/></xsl:call-template>
...
<xsl:template match="/*/form">
	...
	<xsl:call-template name="form_for_news">
...
<!--
	...
	<xsl:call-template name="list_of_linked_files">
		...
		<xsl:with-param name="uplink_type" select="'news'"/>
...
-->
	...
	<xsl:call-template name="list_of_linked_picts">
		...
		<xsl:with-param name="uplink_type" select="'news_gallery'"/>
		<xsl:with-param name="uplink_id"   select="id"/>
	</xsl:call-template>
