...
<xsl:include href="../../xslts/news/view.xslt"/>
...
<xsl:template match="/" mode="overrideable_path">
	...
	<xsl:call-template name="path_this"><xsl:with-param name="text" select="/*/form/data/name"/></xsl:call-template>
</xsl:template>
...
<xsl:template match="/*/form">
	...
	<xsl:call-template name="view_for_news">
