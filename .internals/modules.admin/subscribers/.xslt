...
<xsl:include href="../../xslts/subscribers/list.xslt"/>
...
<xsl:template match="/" mode="overrideable_title">
	<xsl:text>Подписчики</xsl:text>
</xsl:template>

<xsl:template match="/" mode="overrideable_path">
	<xsl:call-template name="path_this"><xsl:with-param name="text" select="'Подписчики'"/></xsl:call-template>
</xsl:template>



<xsl:template match="/*/list">
	<xsl:call-template name="list_of_subscribers">
