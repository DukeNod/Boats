...
<xsl:include href="../../xslts/articles/form.xslt"/>
...
<xsl:template match="/" mode="overrideable_path">
	...
	<xsl:call-template name="path_this"><xsl:with-param name="text" select="'Добавление статьи'"/></xsl:call-template>
</xsl:template>
...
<xsl:template match="/*/form">
	<xsl:call-template name="form_for_article">
