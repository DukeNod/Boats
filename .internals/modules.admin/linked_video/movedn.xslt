...
<xsl:template match="/" mode="overrideable_title">
	<xsl:text>Сдвиг файла вниз</xsl:text>
</xsl:template>
...
<xsl:template match="/" mode="overrideable_path">
	...
	<xsl:call-template name="path_separator"/>
	<xsl:call-template name="path_link"><xsl:with-param name="text" select="'Файлы'"/><xsl:with-param name="link"><xsl:call-template name="smart_link_to_linked_entity"><xsl:with-param name="entity" select="'linked_video'"/></xsl:call-template></xsl:with-param></xsl:call-template>
	<xsl:call-template name="path_separator"/>
