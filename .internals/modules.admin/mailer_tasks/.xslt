...
<xsl:include href="../../xslts/mailer_tasks/list.xslt"/>
...
<xsl:template match="/" mode="overrideable_title">
	<xsl:text>Задания рассылки</xsl:text>
</xsl:template>

<xsl:template match="/" mode="overrideable_path">
	<xsl:call-template name="path_this"><xsl:with-param name="text" select="'Задания рассылки'"/></xsl:call-template>
</xsl:template>



<xsl:template match="/*/list">
	<xsl:call-template name="list_of_mailer_tasks">
