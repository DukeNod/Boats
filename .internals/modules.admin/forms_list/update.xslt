...
<xsl:include href="../../xslts/forms_list/errors.xslt"/>
<xsl:include href="../../xslts/forms_list/form.xslt"/>
...
<xsl:template match="/*/form">
	<xsl:call-template name="form_for_form">
	...
	<h3 class="layoutSubTitle">Поля</h3>
	<xsl:call-template name="list_of_form_fields">
		<xsl:with-param name="node"     select="info/fields"/>
		<xsl:with-param name="essence"  select="'form_fields'"/>
		<xsl:with-param name="form"     select="id"/>
	</xsl:call-template>
</xsl:template>
