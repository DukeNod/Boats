...
if (($action === 'do') && !count($errors)) validate_linked_pict($errors, $data, $config, $enums, $uplink, true);
if (($action === 'do') && !count($errors))   toggle_linked_pict($errors, $data, $id, $field, $value);
