...
<xsl:template match="/" mode="overrideable_path">
	...
	<xsl:call-template name="path_link"><xsl:with-param name="link" select="concat(/*/system/info/adm_root, $adm_sub_root, $essence, '/update/', /*/form/data/id)"/><xsl:with-param name="text" select="/*/form/data/name"/></xsl:call-template>
	<xsl:call-template name="path_separator"/>
