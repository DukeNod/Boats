...
if (($action === 'do') && !count($errors)) validate_linked_file($errors, $data, $config, $enums, $uplink, true);
if (($action === 'do') && !count($errors))   toggle_linked_file($errors, $data, $id, $field, $value);
