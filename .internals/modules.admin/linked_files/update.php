...
_main_::depend('linked_files//forms');
...
$data   = array_merge_rol($defs, $info, form_posted_linked_file($action));
...
if (($action !== null)                   )  prepare_linked_file($errors, $data, $config, $enums, $uplink);
if (($action === 'do') && !count($errors)) validate_linked_file($errors, $data, $config, $enums, $uplink);
if (($action === 'do') && !count($errors))   update_linked_file($errors, $data, $id, $info);
elseif (($action !== null)               ) remember_linked_file($data);
