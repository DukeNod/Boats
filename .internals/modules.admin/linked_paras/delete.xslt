...
<xsl:include href="../../xslts/linked_paras/errors.xslt"/>
<xsl:include href="../../xslts/linked_paras/view.xslt"/>
...
<xsl:template match="/" mode="overrideable_title">
	<xsl:text>Удаление параграфа</xsl:text>
</xsl:template>
...
<xsl:template match="/" mode="overrideable_path">
	...
	<xsl:call-template name="path_separator"/>
	<xsl:call-template name="path_link"><xsl:with-param name="text" select="'Параграфы'"/><xsl:with-param name="link"><xsl:call-template name="smart_link_to_linked_entity"><xsl:with-param name="entity" select="'linked_paras'"/></xsl:call-template></xsl:with-param></xsl:call-template>
	<xsl:call-template name="path_separator"/>
...
<xsl:template match="/*/form">
	<xsl:call-template name="view_for_linked_para">
