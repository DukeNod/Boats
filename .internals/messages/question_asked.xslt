...
<xsl:template match="/" mode="overrideable_title">
	<xsl:value-of select="/*/system/info/sitename"/><xsl:text> - задан вопрос</xsl:text>
</xsl:template>
...
<xsl:template match="/" mode="overrideable_content">
	...
	<h2><xsl:value-of select="/*/system/info/sitename"/> - задан вопрос в разделе "Вопрос-ответ"</h2>
	...
	<table>
		...
		<tr>
			<th>Вопрос</th>
			<td><xsl:value-of select="/*/mail/question"/></td>
		</tr>
	</table>
