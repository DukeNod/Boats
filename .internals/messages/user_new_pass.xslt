...
<xsl:template match="/" mode="overrideable_title">
	<xsl:text>Barybina.ru - смена пароль.</xsl:text>
</xsl:template>
...
<xsl:template match="/" mode="overrideable_content">
	...
	<h2>Ваш пароль к сайту www.barybina.ru был изменен</h2>
	...
	<br/>
	<span class="field">Новый пароль: </span> <xsl:value-of select="/*/module/fields/PasswordToEmail/new_pass"/>
	<br/>
