...
<xsl:template match="/" mode="overrideable_title">
	<xsl:text>Barybina.ru &mdash; новый пользователь &mdash; </xsl:text>
...
<xsl:template match="/" mode="overrideable_content">
	...
	<h2>Новый пользователь зарегистрировался на сайте www.barybina.ru и подтвердил регистрацию.</h2>
